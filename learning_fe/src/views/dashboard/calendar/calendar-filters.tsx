...
import Scrollbar from 'src/components/ui/minimals/scrollbar';
...
export default function CalendarFilters({
  ...
  const renderDateRange = (
    <Stack spacing={1.5} sx={{ mb: 3, px: 2.5 }}>
      <Typography variant="subtitle2">Perioada</Typography>

      <Stack spacing={2}>
        <DatePicker label="De la"
          // romanian locale
          format='dd/MM/yyyy'
          value={filters.startDate} onChange={handleFilterStartDate} />
