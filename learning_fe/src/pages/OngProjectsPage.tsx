                ...
                <Paper key={application.id} sx={{ p: 3, borderRadius: 2 }}>
                  <Stack spacing={2}>
                    <Stack direction="row" justifyContent="space-between" alignItems="center">
                      <Stack direction="row" spacing={2} alignItems="center">                        <Avatar src={application.user?.avatar || undefined} sx={{ width: 40, height: 40 }}>
                    ...
                    )}                    {/* Accept/Reject buttons for applied applications */}
                    {selectedProject?.status === 'open' && application.status === 'applied' && (
